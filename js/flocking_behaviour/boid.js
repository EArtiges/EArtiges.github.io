...
function Boid(boid_index, x, y, flk, cohesionSlider, separationSlider, alignmentSlider, distanceSlider) {
  ...
  this.render = function() {
    ...
    flk.stroke(200);
    flk.push();
    flk.translate(this.position.x, this.position.y);
    flk.rotate(theta);
    flk.beginShape();
    flk.vertex(0, -this.r * 2);
    flk.vertex(-this.r, this.r * 2);
    flk.vertex(this.r, this.r * 2);
    flk.endShape(flk.CLOSE);
    flk.pop();
  };

  // Wraparound
  this.borders = function() {
    if (this.position.x < -this.r) this.position.x = flk.width + this.r;
    if (this.position.y < -this.r) this.position.y = flk.height + this.r;
    if (this.position.x > flk.width + this.r) this.position.x = -this.r;
    if (this.position.y > flk.height + this.r) this.position.y = -this.r;
  }
