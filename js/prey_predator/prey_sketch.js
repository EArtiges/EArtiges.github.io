...
let preypred_sketch = function (p5_prey,n_rows,n_cols) {
  ...
  p5_prey.setup = function(){
    ...
    p5_prey.conditions_button.addClass("p5-button")
    p5_prey.conditions_button.mouseClicked(p5_prey.change_conditions);

    // Play or pause the animation
    p5_prey.stop_button = p5_prey.createButton('Play').parent('prey-stop-button');
    p5_prey.stop_button.addClass("p5-button")
    p5_prey.stop_button.mouseClicked(p5_prey.play_or_pause);

    // Wipe all life. Clean start. #Thanos
     p5_prey.reset_button = p5_prey.createButton('Reset grid').parent('prey-reset-button');
     p5_prey.reset_button.addClass("p5-button")
...
//    p5_prey.frameRate(24);
  ...
  p5_prey.play_or_pause = function(){
    if (field_anim) {
          p5_prey.stop_button.remove()
          p5_prey.stop_button = p5_prey.createButton('Play').parent('prey-stop-button');
          p5_prey.stop_button.addClass("p5-button")
          p5_prey.stop_button.mouseClicked(p5_prey.play_or_pause);
          ...
          p5_prey.stop_button.remove()
          p5_prey.stop_button = p5_prey.createButton('Pause').parent('prey-stop-button');
          p5_prey.stop_button.addClass("p5-button")
          p5_prey.stop_button.mouseClicked(p5_prey.play_or_pause);
